...
A secure, full-stack social media application with end-to-end encrypted messaging, OTP verification, admin moderation, and HTTPS security. Built for the FCS course by Group 29 (Sharad Jain & Akash Singh).
...
### Prerequisites
- Java 23 (See Installation Guide below)
- MySQL 8.0+
...
npm install
ng build --prod
Deploy: Copy dist/ contents to /var/www/html and configure Nginx (see config below).

4. Database Setup
Run the provided script.sql to initialize tables:
...
Note: Browsers may warn about self-signed HTTPS certificates. Click "Advanced" then "Proceed".
